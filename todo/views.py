    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'createtodo.html', {'form': TodoForm(), 'error':
                                                       'Title is too long(>100 characters)'})
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'viewtodo.html', {'form': form, 'todo': todo})
    else:
        try:
            ...
            return render(request, 'viewtodo.html', {'form': form, 'todo': todo, 'error': 'Bad info'})
